<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Bod_Tracking, App_Web_bod_tracking.aspx.1f2a64c3" %>
    ...
    <asp:UpdatePanel ID="upbreadcrumb" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <ul id="breadcrumb">
                ...
                <li><a href="../Admin/Bods_View.aspx"><%= Resources.CMS_Resource.lblBods %></a></li>
                <li><i class="fa fa-lg fa-angle-right"></i></li>
