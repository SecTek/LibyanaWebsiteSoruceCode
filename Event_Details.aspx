<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Event_Details, App_Web_event_details.aspx.cdcab7d2" %>
        ...
        <div class="row">
            <div class="col col_12_of_12 breadcrumb-outer">
                <ul class="breadcrumb">
                    ...
                    <li><a href="Events.aspx"><%= Resources.SITE_Resource.Events%></a></li>
        ...
        <div class="row">
            ...
            <div class="col col_4_of_12 news-headline-outer">
                ...
                <asp:Repeater ID="rpt" runat="server">
                    <ItemTemplate>
                        <a href="Event_Details.aspx?id=<%# Eval("ID_MAIN") %>">
                            <div class=" col_12_of_12 no-padding-right news-headline-inner">
                                ...
                                <div class="right-side">
                                    ...
                                    <%--<h3><%# Eval("START_DATE", "{0: dd/MM/yyyy}") +" - " + Eval("END_DATE", "{0: dd/MM/yyyy}") %></h3>--%>
                                </div>
                            </div>
                        </a>
                    </ItemTemplate>
