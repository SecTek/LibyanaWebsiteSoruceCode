<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Rotater_Tracking, App_Web_rotater_tracking.aspx.1f2a64c3" %>
    ...
    <asp:UpdatePanel ID="upbreadcrumb" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <ul id="breadcrumb">
                ...
                <li><a href="../Admin/Rotaters_View.aspx"><%= Resources.CMS_Resource.lblRotaters %></a></li>
                <li><i class="fa fa-lg fa-angle-right"></i></li>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtLinkText_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtBody_Old" runat="server" CssClass="form-control" Style="height: 150px !important" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblLinkText %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtLinkText_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblImage %></label>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblBody %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtBody_New" runat="server" CssClass="form-control" Style="height: 150px !important" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
