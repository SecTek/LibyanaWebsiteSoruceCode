<%@ page title="Imagin grp. : Content Management System" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Bod_Auditing, App_Web_bod_auditing.aspx.1f2a64c3" %>
                                ...
                                <ContentTemplate>
                                    <div class="form-horizontal bucket-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <asp:TextBox ID="txtJobTitle" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
