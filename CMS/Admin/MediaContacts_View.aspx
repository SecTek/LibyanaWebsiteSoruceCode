<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="MediaContacts_View, App_Web_mediacontacts_view.aspx.1f2a64c3" %>

<%@ Register TagPrefix="cc1" Assembly="Custom_Button" Namespace="Custom_Button" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script>
        $(window).load(function () {
            $('#tblData_MediaContact').DataTable({
                stateSave: true
            });
            $('#tblData_MediaContact2').DataTable({
                stateSave: true
            });
        });
    </script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><%= Resources.CMS_Resource.lblMediaContacts %></li>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphBodyContent" runat="Server">
    <div class="body-nest" id="footable" runat="server">
        <table id="tblData_MediaContact" class="table-striped  footable metro-blue gvDataClass" width="100%">
            <thead>
                <tr>
            ...
            <tbody>
                <asp:Repeater ID="rptData" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td style="width: 35%"><%# Eval("NAME") %></td>
                            ...
                            <td class="Hiddein_TD"><%# Eval("PHONE").ToString() %></td>
                            <td class="Hiddein_TD"><%# Eval("FAX").ToString() %></td>
                            <td class="Hiddein_TD"><%# Eval("MOBILE").ToString() %></td>
                            <td class="Hiddein_TD"><%# Eval("EMAIL").ToString() %></td>
                            <td style="width: 15%">
    ...
    <div class="body-nest no-padding-bot">
        ...
        <div runat="server" id="footable2">
            <table id="tblData_MediaContact2" class="table-striped  footable metro-blue gvDataClass" width="100%">
                <thead>
                    <tr>
                        <th><%= Resources.CMS_Resource.lblName %></th>
