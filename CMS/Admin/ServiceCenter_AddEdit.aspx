<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="ServiceCenter_AddEdit, App_Web_servicecenter_addedit.aspx.1f2a64c3" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><a href="ServiceCenters_View.aspx"><%= Resources.CMS_Resource.lblServicesCenters %></a></li>
        <li><i class="fa fa-lg fa-angle-right"></i></li>
                                    ...
                                    <div class="form-horizontal bucket-form">
                                        <div runat="server" id="div_tab_main">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="txtMorningPeriod" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblEveningPeriod %></label>
                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="txtEveningPeriod" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblCity %></label>
                                    <div class="col-sm-6">
                                        <asp:DropDownList ID="ddlCity_Save" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblMorningPeriod %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtMorningPeriod_Save" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblEveningPeriod %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtEveningPeriod_Save" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblTel %></label>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblLatitude %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtLatitude_Save" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblLongitude %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtLongitude_Save" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblAddress %></label>
