<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Banners_View, App_Web_banners_view.aspx.1f2a64c3" %>

<%@ Register TagPrefix="cc1" Assembly="Custom_Button" Namespace="Custom_Button" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script>
        $(window).load(function () {
            $('#tblData_Banner').DataTable({
                stateSave: true
            });
            $('#tblData_Banner2').DataTable({
                stateSave: true
            });
        });
    </script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><%= Resources.CMS_Resource.lblBanners %></li>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphBodyContent" runat="Server">
    <div class="body-nest" id="footable" runat="server">
        <table id="tblData_Banner" class="table-striped  footable metro-blue gvDataClass" width="100%">
            <thead>
                <tr>
                    <th><%= Resources.CMS_Resource.lblBannerName %></th>
                    <th><%= Resources.CMS_Resource.lblType %></th>
                    <th><%= Resources.CMS_Resource.IsInnerPageBanner %></th>
                    ...
                    <th class="Hiddein_TD"><%= Resources.CMS_Resource.BannerSide %></th>
                    <th class="Hiddein_TD"><%= Resources.CMS_Resource.lblBody %></th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
                <asp:Repeater ID="rptData" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td style="width: 25%"><%# Eval("BANNER_NAME") %></td>
                            <td style="width: 8%"><%# Localization.GetIsBusiness(Eval("IS_BUSINESS")) %></td>
                            <td style="width: 8%"><%# Localization.GetIsInnerBanner(Eval("IS_INNER_PAGE_BANNER")) %></td>
                            <td style="width: 8%"><%# Localization.GetStatus(Eval("IS_ACTIVE")) %></td>
                            <td style="width: 8%"><%# Localization.GetDeletedStatus(Eval("IS_DELETED")) %></td>
                            <td style="width: 8%"><%# Localization.GetPublishStatus(Eval("IS_PUBLISHED")) %></td>
                            <td style="width: 10%"><%# Eval("CHECKED_OUT_BY_NAME") %></td>
                            <td style="width: 10%"><%# Localization.GetCheckedDate(Eval("CHECKED_OUT_DATE")) %></td>
                            <td class="Hiddein_TD"><%# GetIsFooterBanner(Eval("IS_FOOTER_BANNER")) %></td>
                            <td class="Hiddein_TD"><%# Localization.StripTagsRegex(Eval("BODY").ToString()) %></td>
                            <td style="width: 15%">
    ...
    <div class="body-nest no-padding-bot">
        ...
        <div runat="server" id="footable2">
            <table id="tblData_Banner2" class="table-striped  footable metro-blue gvDataClass" width="100%">
                <thead>
                    <tr>
                        <th><%= Resources.CMS_Resource.lblBannerName %></th>
                        <th><%= Resources.CMS_Resource.lblType %></th>
                ...
                <tbody>
                    <asp:Repeater ID="rptData2" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                <td style="width: 15%"><%# Eval("BANNER_NAME") %></td>
                                <td style="width: 8%"><%# Localization.GetIsBusiness(Eval("IS_BUSINESS")) %></td>
                                <td style="width: 8%"><%# Localization.GetIsInnerBanner(Eval("IS_INNER_PAGE_BANNER")) %></td>
                                <td style="width: 8%"><%# Localization.GetLanguage(Eval("ID_LANG")) %></td>
                                <td style="width: 8%"><%# Localization.GetAuditingStatus(Eval("ID_STATUS")) %></td>
                                <td style="width: 8%"><%# Eval("USERNAME") %></td>
