<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="GroupModules, App_Web_groupmodules.aspx.1f2a64c3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphTitle" runat="Server">
    <span><%= Resources.CMS_Resource.lblGroupModules %></span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><i class="fa fa-lg fa-angle-right"></i></li>
        <li><%= Resources.CMS_Resource.lblGroupModules %></li>
        <li class="pull-right">
        ...
        <asp:UpdatePanel runat="server" ID="upList" UpdateMode="Conditional">
            <ContentTemplate>
                <table id="tblData" class="table-striped footable-res footable metro-blue gvDataClass custom-pager" data-page-size="10" data-filter="#filter" data-filter-text-only="true">
                    <thead>
                        <tr>
                            <th><%= Resources.CMS_Resource.lblModule %></th>
                    ...
                    <tbody>
                        <aspRepeater:DataPagerRepeater ID="rptData" PersistentDataSource="true" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td style="width: 55%"><%# (Eval("NAME")) %></td>
