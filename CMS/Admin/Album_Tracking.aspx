<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Album_Tracking, App_Web_album_tracking.aspx.1f2a64c3" %>
    ...
    <asp:UpdatePanel ID="upbreadcrumb" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <ul id="breadcrumb">
                ...
                <li><a href="../Admin/Albums_View.aspx"><%= Resources.CMS_Resource.lblAlbums %></a></li>
                <li><i class="fa fa-lg fa-angle-right"></i></li>
                        ...
                        <ItemTemplate>
                            <tr>
                                <td style="width: 3%">
                                    ...
                                    <asp:CheckBox CssClass="frm_Checkbox" ID="CASelect" runat="server" type="checkbox"></asp:CheckBox>
                                </td>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 skin-flat list CA_Row_Height">
                                        <asp:CheckBox CssClass="frm_Checkbox" ID="CAIsActive_Old" runat="server" type="checkbox"></asp:CheckBox>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"></label>
                                    <div class="col-sm-6 skin-flat list CA_Row_Height">
                                        <asp:CheckBox CssClass="frm_Checkbox" ID="CAIsDeleted_Old" runat="server" type="checkbox"></asp:CheckBox>
                                ...
                                <div class="form-group">
                                    ...
                                    <a id="aUploadedFile_Old" runat="server" target="_blank" class="btn btn-warning ImagePopup" onclick="ImagePopup();"><%= Resources.CMS_Resource.lblShowImage %></a>
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"></label>
                                    <div class="col-sm-6 skin-flat list CA_Row_Height">
                                        <asp:CheckBox CssClass="frm_Checkbox" ID="CAIsActive_New" runat="server" type="checkbox"></asp:CheckBox>
                                        <label for="flat-checkbox-1"><%= Resources.CMS_Resource.lblIsActive %></label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"></label>
                                    <div class="col-sm-6 skin-flat list CA_Row_Height">
                                        <asp:CheckBox CssClass="frm_Checkbox" ID="CAIsDeleted_New" runat="server" type="checkbox"></asp:CheckBox>
                                        <label for="flat-checkbox-1"><%= Resources.CMS_Resource.lblIsDeleted %></label>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <a id="aUploadedFile_New" runat="server" target="_blank" class="btn btn-warning ImagePopup" onclick="ImagePopup();"><%= Resources.CMS_Resource.lblShowImage %></a>
                                </div>
                            </div>
                        </div>
                    </section>
