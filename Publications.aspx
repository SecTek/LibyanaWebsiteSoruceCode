<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Publications, App_Web_publications.aspx.cdcab7d2" %>
                        ...
                        <aspRepeater:DataPagerRepeater ID="rpt" PersistentDataSource="true"
                            ...
                            <ItemTemplate>
                                <li class="li-publications">
                                    <a href="<%# GetFile(Eval("UPLOADED_FILE")) %>" target="_blank">
                                        <div class="div-publications-img" style="background-image: url('<%# GetImage(Eval("IMAGE")) %>')">
                                            <div class="div-publications-link-section"><%# Eval("TITLE") %></div>
                                        </div>
                                    </a>
                                </li>
                            </ItemTemplate>
