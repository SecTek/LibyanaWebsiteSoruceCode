<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Services_View, App_Web_services_view.aspx.1f2a64c3" %>

<%@ Register TagPrefix="cc1" Assembly="Custom_Button" Namespace="Custom_Button" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
      <script>
        $(window).load(function () {
            $('#tblData_Service').DataTable({
                stateSave: true
            });
            $('#tblData_Service2').DataTable({
                stateSave: true
            });
        });
</script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><%= Resources.CMS_Resource.lblServices %></li>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphBodyContent" runat="Server">
    <div class="body-nest" id="footable" runat="server">
        <table id="tblData_Service" class="table-striped  footable metro-blue gvDataClass" width="100%">
            <thead>
                <tr>
                ...
                <asp:Repeater ID="rptData" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 10%"><%# Localization.GetIsBusiness(Eval("IS_BUSINESS")) %></td>
    ...
    <div class="body-nest no-padding-bot">
        ...
        <table id="tblData_Service2" class="table-striped  footable metro-blue gvDataClass" width="100%">
                <thead>
                    <tr>
                        <th><%= Resources.CMS_Resource.lblTitle %></th>
                        <th><%= Resources.CMS_Resource.lblParentTitle %></th>
