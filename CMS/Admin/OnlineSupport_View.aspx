<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="OnlineSupport_View, App_Web_onlinesupport_view.aspx.1f2a64c3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
      <script>
          $(window).load(function () {
              $('#tblData_OnlineSupport').DataTable({
                  stateSave: true
              });
          });
</script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><%= Resources.CMS_Resource.lblOnline_Support %></li>
    </ul>
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="cphBodyContent" runat="Server">
    <div class="body-nest" id="footable" runat="server">
       
        <table id="tblData_OnlineSupport" class="table-striped  footable metro-blue gvDataClass" width="100%">
            <thead>
                <tr>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 15%">
                                ...
                                <div id="Div1" runat="server" visible='<%# !(Convert.ToBoolean(Eval("IS_DELETED"))) %>'>
