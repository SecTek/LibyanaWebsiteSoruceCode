<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Contents_View, App_Web_contents_view.aspx.1f2a64c3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script>
        $(window).load(function () {
            $('#tblData_Content').DataTable({
                stateSave: true
            });
            $('#tblData_Content2').DataTable({
                stateSave: true
            });
        });
    </script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><%= Resources.CMS_Resource.lblContents %></li>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphBodyContent" runat="Server">
    <div class="body-nest" id="footable" runat="server">
        <table id="tblData_Content" class="table-striped  footable metro-blue gvDataClass" width="100%">
            <thead>
                <tr>
    ...
    <div class="body-nest no-padding-bot">
        ...
        <div runat="server" id="footable2">
            <table id="tblData_Content2" class="table-striped  footable metro-blue gvDataClass" width="100%">
                <thead>
                    <tr>
                        <th><%= Resources.CMS_Resource.lblTitle %></th>
                        <th><%= Resources.CMS_Resource.lblParentTitle %></th>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="width: 15%">
                                    ...
                                    <div runat="server">
                                        <asp:LinkButton runat="server" ID="lbView" CssClass="icon-preview LinkButton-Image" OnClick="lbView_Click" OnClientClick="window.document.forms[0].target='_blank';"></asp:LinkButton>
                                    </div>
