<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Packages_View, App_Web_packages_view.aspx.1f2a64c3" %>

<%@ Register TagPrefix="cc1" Assembly="Custom_Button" Namespace="Custom_Button" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
      <script>
        $(window).load(function () {
            $('#tblData_Package').DataTable({
                stateSave: true
            });
            $('#tblData_Package2').DataTable({
                stateSave: true
            });
        });
</script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><%= Resources.CMS_Resource.lblPackages %></li>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphBodyContent" runat="Server">
    <div class="body-nest" id="footable" runat="server">
        <table id="tblData_Package" class="table-striped  footable metro-blue gvDataClass" width="100%">
            <thead>
                <tr>
                ...
                <asp:Repeater ID="rptData" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 10%"><%# Localization.GetIsMobilePackage(Eval("IS_MOBILE_PACKAGE")) %></td>
                            ...
                            <td class="Hiddein_TD"><%# Eval("PROPERTY_1") %></td>
                            <td class="Hiddein_TD"><%# Eval("PROPERTY_1_VALUE") %></td>
                            <td class="Hiddein_TD"><%# Eval("PROPERTY_2") %></td>
                            <td class="Hiddein_TD"><%# Eval("PROPERTY_2_VALUE") %></td>
                            <td class="Hiddein_TD"><%# Eval("PROPERTY_3") %></td>
                            <td class="Hiddein_TD"><%# Eval("PROPERTY_3_VALUE") %></td>
                            <td class="Hiddein_TD"><%# Eval("PROPERTY_4") %></td>
                            <td class="Hiddein_TD"><%# Eval("PROPERTY_4_VALUE") %></td>
                            <td class="Hiddein_TD"><%# Eval("PROPERTY_5") %></td>
                            <td class="Hiddein_TD"><%# Eval("PROPERTY_5_VALUE") %></td>
                            <td class="Hiddein_TD"><%# Eval("PROPERTY_6") %></td>
                            <td class="Hiddein_TD"><%# Eval("PROPERTY_6_VALUE") %></td>
                            <td class="Hiddein_TD"><%# Eval("PROPERTY_7") %></td>
                            <td class="Hiddein_TD"><%# Eval("PROPERTY_7_VALUE") %></td>
                            <td class="Hiddein_TD"><%# Eval("PROPERTY_8") %></td>
                            <td class="Hiddein_TD"><%# Eval("PROPERTY_8_VALUE") %></td>
                            <td class="Hiddein_TD"><%# Eval("BODY") %></td>
                            <td style="width: 15%">
    ...
    <div class="body-nest no-padding-bot">
        ...
        <table id="tblData_Package2" class="table-striped  footable metro-blue gvDataClass" width="100%">
                <thead>
                    <tr>
                        <th><%= Resources.CMS_Resource.lblTitle %></th>
                        <th><%= Resources.CMS_Resource.lblType %></th>
                ...
                <tbody>
                    <asp:Repeater ID="rptData2" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                <td style="width: 15%"><%# Eval("TITLE") %></td>
                                <td style="width: 10%"><%# Localization.GetIsMobilePackage(Eval("IS_MOBILE_PACKAGE")) %></td>
