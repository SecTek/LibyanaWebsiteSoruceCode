<%@ page title="Imagin grp. : Content Management System" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Event_Auditing, App_Web_event_auditing.aspx.1f2a64c3" %>
                            ...
                            <asp:UpdatePanel runat="server" ID="upEntry" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div class="form-horizontal bucket-form">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblStartDate %></label>
                                            <div class="col-sm-6">
                                                <div class="Div_DateTime_Date">
                                                    <asp:TextBox ID="dpStartDate" runat="server" CssClass="form-control ReqValidation DateValidation DatePicker" type="text"></asp:TextBox>
                                                </div>
                                                <div class="Div_DateTime_Time">
                                                    <asp:TextBox ID="tpStartTime" runat="server" CssClass="form-control ReqValidation TimePicker" type="text" data-format="hh:mm A"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
