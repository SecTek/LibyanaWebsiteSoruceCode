<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="AddedValues_View, App_Web_addedvalues_view.aspx.1f2a64c3" %>

<%@ Register TagPrefix="cc1" Assembly="Custom_Button" Namespace="Custom_Button" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
      <script>
          $(window).load(function () {
              $('#tblData_AddedValue').DataTable({
                  stateSave: true
              });
              $('#tblData_AddedValue2').DataTable({
                  stateSave: true
              });
          });
</script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><%= Resources.CMS_Resource.lblAddedValues %></li>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphBodyContent" runat="Server">
    <div class="body-nest" id="footable" runat="server">
        <table id="tblData_AddedValue" class="table-striped  footable metro-blue gvDataClass" width="100%">
            <thead>
                <tr>
    ...
    <div class="body-nest no-padding-bot">
        ...
        <table id="tblData_AddedValue2" class="table-striped  footable metro-blue gvDataClass" width="100%">
                <thead>
                    <tr>
                        <th><%= Resources.CMS_Resource.lblTitle %></th>
                        <th><%= Resources.CMS_Resource.lblParentTitle %></th>
