<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Photo_Tracking, App_Web_photo_tracking.aspx.1f2a64c3" %>
    ...
    <asp:UpdatePanel ID="upbreadcrumb" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <ul id="breadcrumb">
                ...
                <li><a href="../Admin/Photos_View.aspx"><%= Resources.CMS_Resource.lblPhotos %></a></li>
                <li><i class="fa fa-lg fa-angle-right"></i></li>
