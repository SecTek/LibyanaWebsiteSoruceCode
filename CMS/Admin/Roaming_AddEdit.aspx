<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Roaming_AddEdit, App_Web_roaming_addedit.aspx.1f2a64c3" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><a href="Roamings_View.aspx"><%= Resources.CMS_Resource.lblRoaming %></a></li>
        <li><i class="fa fa-lg fa-angle-right"></i></li>
        <li runat="server" id="li_BreadCrumbs"></li>
        <li class="pull-right" runat="server" id="li_AddNew">
            <div class="input-group input-widget">
                <a href="Roaming_AddEdit.aspx" class="btn btn-danger"><%= Resources.CMS_Resource.lblCreateNew %> <%= Resources.CMS_Resource.lblRoaming %></a>
            </div>
        </li>
    </ul>
</asp:Content>
                                    ...
                                    <div class="form-horizontal bucket-form">
                                        <div runat="server" id="div_tab_main">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"></label>
                                                   <div class="col-sm-6 skin-flat list cb_Row_Height">
                                                    ...
                                                    <div class="col-sm-4 ">
                                                        <asp:CheckBox CssClass="frm_Checkbox" ID="cbRoaminginPlane" runat="server" type="checkbox"></asp:CheckBox>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="txtCountryValue" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblLibya %></label>
                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="txtLibya" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblArabic_Europe_Countries %></label>
                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="txtArabicEuropeCountries" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblRest_Of_Word %></label>
                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="txtRestOfWord" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblThuraia %></label>
                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="txtThuraia" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblSatellites %></label>
                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="txtSatellites" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblReceived_Callings %></label>
                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="txtReceivedCallings" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblSMS %></label>
                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="txtSMS" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblInternet %></label>
                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="txtInternet" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div id="Div1" class="form-group" runat="server" visible='<%# Show_Element_Based_On_Permission(true,false,true,false,false,false,false) %>'>
                                                <label class="col-sm-3 control-label"></label>
                                                <div class="col-sm-6 skin-flat list cb_Row_Height">
                            ...
                            <div class="form-horizontal bucket-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 skin-flat list cb_Row_Height">
                                        ...
                                        <div class="col-sm-4 ">
                                            <asp:CheckBox CssClass="frm_Checkbox" ID="cbRoaminginPlane_Save" runat="server" type="checkbox"></asp:CheckBox>
                                            <label for="flat-checkbox-1"><%= Resources.CMS_Resource.lblRoaminginPlane %></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblCountry %></label>
                                    <div class="col-sm-6">
                                        <asp:DropDownList ID="ddlCountry_Save" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblCountry_Value %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtCountryValue_Save" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblLibya %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtLibya_Save" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblArabic_Europe_Countries %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtArabicEuropeCountries_Save" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblRest_Of_Word %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtRestOfWord_Save" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblThuraia %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtThuraia_Save" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblSatellites %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtSatellites_Save" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblReceived_Callings %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtReceivedCallings_Save" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblSMS %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtSMS_Save" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblInternet %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtInternet_Save" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
