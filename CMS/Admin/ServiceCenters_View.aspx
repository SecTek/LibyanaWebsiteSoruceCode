<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="ServiceCenters_View, App_Web_servicecenters_view.aspx.1f2a64c3" %>

<%@ Register TagPrefix="cc1" Assembly="Custom_Button" Namespace="Custom_Button" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
      <script>
          $(window).load(function () {
              $('#tblData_ServiceCenter').DataTable({
                  stateSave: true
              });
              $('#tblData_ServiceCenter2').DataTable({
                  stateSave: true
              });
          });
</script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphTitle" runat="Server">
    <span><%= Resources.CMS_Resource.lblServicesCenters %></span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        <li><a href="Dashboard.aspx"><%= Resources.CMS_Resource.lblDashboard %></a></li>
        <li><i class="fa fa-lg fa-angle-right"></i></li>
        <li><%= Resources.CMS_Resource.lblServiceCenter %></li>
        <li class="pull-right" runat="server" id="Div_AddNew">
            <div class="input-group input-widget">
                <a href="ServiceCenter_AddEdit.aspx" class="btn btn-danger"><%= Resources.CMS_Resource.lblCreateNew %> <%= Resources.CMS_Resource.lblServiceCenter %></a>
            </div>
        </li>
    </ul>
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="cphBodyContent" runat="Server">
    <div class="body-nest" id="footable" runat="server">
        <table id="tblData_ServiceCenter" class="table-striped  footable metro-blue gvDataClass" width="100%">
            <thead>
                <tr>
                ...
                <asp:Repeater ID="rptData" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="Hiddein_TD"><%# Eval("MORNING") %></td>
                            <td class="Hiddein_TD"><%# Eval("EVENING") %></td>
                            <td class="Hiddein_TD"><%# Eval("TEL") %></td>
                            <td class="Hiddein_TD"><%# Eval("FAX") %></td>
    ...
    <div class="body-nest no-padding-bot">
        ...
        <table id="tblData_ServiceCenter2" class="table-striped  footable metro-blue gvDataClass" width="100%">
                <thead>
                    <tr>
                        <th><%= Resources.CMS_Resource.lblTitle %></th>
