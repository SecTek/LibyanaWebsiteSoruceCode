<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Media_Contacts, App_Web_media_contacts.aspx.cdcab7d2" %>
                        ...
                        <aspRepeater:DataPagerRepeater ID="rpt" PersistentDataSource="true"
                            ...
                            <ItemTemplate>
                                <li class="li-publications">
                                    <a href="MediaContactDetail.aspx?ID=<%# Eval("ID_MAIN") %>" target="_blank">
                                        <div class="div-publications-img" style="background-image: url('<%# GetImage(Eval("IMAGE")) %>')">
                                        </div>
                                        <div class="div-publications-link-section"><%# Eval("NAME") %></div>
                                    </a>
                                </li>
                            </ItemTemplate>
