<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Job_Tracking, App_Web_job_tracking.aspx.1f2a64c3" %>
    ...
    <asp:UpdatePanel ID="upbreadcrumb" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <ul id="breadcrumb">
                ...
                <li><a href="../Admin/Jobs_View.aspx"><%= Resources.CMS_Resource.lblJobs %></a></li>
                <li><i class="fa fa-lg fa-angle-right"></i></li>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDepartment_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtJobReference_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblPublicationDate %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtPublicationDate_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="body-nest">
                                    <uc1:CustomRadEditor runat="server" ID="reDescription_Old" />
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblDepartment %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDepartment_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblTitle %></label>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblJobReference %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtJobReference_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblPublicationDate %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtPublicationDate_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group ContainFTB">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblDescription %></label>
                                ...
                                <div class="body-nest">
                                    <uc1:CustomRadEditor runat="server" ID="reDescription_New" />
                                </div>
                            </div>
                        </div></div>
                    </section>
