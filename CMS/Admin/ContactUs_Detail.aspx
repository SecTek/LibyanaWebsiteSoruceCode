<%@ page title="Imagin grp. : Content Management System" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="ContactUs_Detail, App_Web_contactus_detail.aspx.1f2a64c3" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><a href="ContactUs_View.aspx"><%= Resources.CMS_Resource.lblContact_Us %></a></li>
        <li><i class="fa fa-lg fa-angle-right"></i></li>
