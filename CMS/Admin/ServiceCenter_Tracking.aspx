<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="ServiceCenter_Tracking, App_Web_servicecenter_tracking.aspx.1f2a64c3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphTitle" runat="Server">
    <span><%= Resources.CMS_Resource.lblServiceCenter %></span>
</asp:Content>
    ...
    <asp:UpdatePanel ID="upbreadcrumb" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <ul id="breadcrumb">
                ...
                <li><a href="../Admin/ServiceCenters_View.aspx"><%= Resources.CMS_Resource.lblServicesCenters %></a></li>
                <li><i class="fa fa-lg fa-angle-right"></i></li>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtCity_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblMorningPeriod %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtMorningPeriod_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblEveningPeriod %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtEveningPeriod_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblTel %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtTel_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblFax %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtFax_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblEmail %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtEmail_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblLatitude %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtLatitude_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblLongitude %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtLongitude_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblAddress %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtAddress_Old" runat="server" CssClass="form-control" TextMode="MultiLine" Style="height: 100px !important"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblCity %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtCity_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblMorningPeriod %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtMorningPeriod_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblEveningPeriod %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtEveningPeriod_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblTel %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtTel_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblFax %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtFax_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblEmail %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtEmail_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblLatitude %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtLatitude_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblLongitude %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtLongitude_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblAddress %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtAddress_New" runat="server" CssClass="form-control" TextMode="MultiLine" Style="height: 100px !important"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
