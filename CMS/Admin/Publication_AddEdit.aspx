<%@ page title="Imagin grp. : Content Management System" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Publication_AddEdit, App_Web_publication_addedit.aspx.1f2a64c3" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><a href="Publications_View.aspx"><%= Resources.CMS_Resource.lblPublications %></a></li>
        <li><i class="fa fa-lg fa-angle-right"></i></li>
        <li runat="server" id="li_BreadCrumbs"></li>
        <li class="pull-right" runat="server" id="li_AddNew">
            <div class="input-group input-widget">
                <a href="Publication_AddEdit.aspx" class="btn btn-danger"><%= Resources.CMS_Resource.lblCreateNew %> <%= Resources.CMS_Resource.lblPublication %></a>
            </div>
        </li>
    </ul>
</asp:Content>
                                                    ...
                                                    <asp:UpdatePanel runat="server" ID="upImage" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            ...
                                                            <div class="help-block">
                                                                ...
                                                                <asp:Literal runat="server" ID="lFieldMessage_Image" Text="<%$ Resources:CMS_Resource, SourceFolder %>"></asp:Literal><span><%= ConfigurationManager.AppSettings["Att_PublicationImages"] %></span>
                                                          </div>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <asp:UpdatePanel runat="server" ID="upUploadedFile" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            ...
                                                            <div class="help-block">
                                                                <asp:Literal runat="server" ID="lFieldMessage_UploadedFile" Text="<%$ Resources:CMS_Resource, SourceFolder %>"></asp:Literal><span><%= ConfigurationManager.AppSettings["Att_Publication"] %></span>
                                                            </div>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                            ...
                            <div class="form-horizontal bucket-form">
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="col-sm-6">
                                        <asp:UpdatePanel runat="server" ID="upImage_Save" UpdateMode="Conditional">
                                            ...
                                            <asp:Literal runat="server" ID="lFieldMessage_Image_Save" Text="<%$ Resources:CMS_Resource, SourceFolder %>"></asp:Literal><span><%= ConfigurationManager.AppSettings["Att_PublicationImages"] %></span>
                                        </div>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="help-block">
                                            <asp:Literal runat="server" ID="lFieldMessage_UploadedFile_Save" Text="<%$ Resources:CMS_Resource, SourceFolder %>"></asp:Literal><span><%= ConfigurationManager.AppSettings["Att_Publication"] %></span>
                                        </div>
                                    </div>
                                </div>
