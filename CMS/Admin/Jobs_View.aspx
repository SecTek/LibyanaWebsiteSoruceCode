<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Jobs_View, App_Web_jobs_view.aspx.1f2a64c3" %>

<%@ Register TagPrefix="cc1" Assembly="Custom_Button" Namespace="Custom_Button" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
      <script>
          $(window).load(function () {
              $('#tblData_Job').DataTable({
                  stateSave: true
              });
              $('#tblData_Job2').DataTable({
                  stateSave: true
              });
          });
</script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><%= Resources.CMS_Resource.lblJobs %></li>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphBodyContent" runat="Server">
    <div class="body-nest" id="footable" runat="server">
        <table id="tblData_Job" class="table-striped  footable metro-blue gvDataClass" width="100%">
            <thead>
                <tr>
                    <th><%= Resources.CMS_Resource.lblTitle %></th>
                    <th><%= Resources.CMS_Resource.lblDepartment %></th>
                ...
                <asp:Repeater ID="rptData" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 15%"><%# Eval("DEPARTMENT") %></td>
    ...
    <div class="body-nest no-padding-bot">
        ...
        <table id="tblData_Job2" class="table-striped  footable metro-blue gvDataClass" width="100%">
                <thead>
                    <tr>
                        <th><%= Resources.CMS_Resource.lblTitle %></th>
                        <th><%= Resources.CMS_Resource.lblParentTitle %></th>
                    ...
                    <asp:Repeater ID="rptData2" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="width: 10%"><%# Eval("PARENT_TITLE") %></td>
                                <td style="width: 5%"><%# Localization.GetLanguage(Eval("ID_LANG")) %></td>
                                <td style="width: 5%"><%# Localization.GetAuditingStatus(Eval("ID_STATUS")) %></td>
