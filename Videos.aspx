<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Videos, App_Web_videos.aspx.cdcab7d2" %>
                ...
                <asp:UpdatePanel runat="server" ID="up" UpdateMode="Conditional">
                    <ContentTemplate>
                        <aspRepeater:DataPagerRepeater ID="rpt" PersistentDataSource="true"
                            ...
                            <ItemTemplate>
                                <li class="li-photos">
                                    <a class="video-colorbox" title="<%# Eval("TITLE") %>" href="<%# Eval("VIDEO") %>">
                                        <div class="div-albums-img" style="background-image: url('<%# GetImage(Eval("VIDEO")) %>')"></div>
                                        <div class="div-albums-link-section"><%# Eval("TITLE") %></div>
                                    </a>
                                </li>
                            </ItemTemplate>
