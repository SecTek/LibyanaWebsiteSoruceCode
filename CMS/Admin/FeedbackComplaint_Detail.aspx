<%@ page title="Imagin grp. : Content Management System" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="FeedbackComplaint_Detail, App_Web_feedbackcomplaint_detail.aspx.1f2a64c3" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphTitle" runat="Server">
    <span runat="server" id="spanHeaderTitle"></span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        <li><a href="Dashboard.aspx"><%= Resources.CMS_Resource.lblDashboard %></a></li>
        <li><i class="fa fa-lg fa-angle-right"></i></li>
        <li><a href="FeedbackComplaints_View.aspx"><%= Resources.CMS_Resource.lblFeedbackComplaint %></a></li>
        <li><i class="fa fa-lg fa-angle-right"></i></li>
        ...
        <div class="wizard-tab">
            ...
            <section class="UnderValidationSection">
                <div class="panel-body">
                    <div class="form-horizontal bucket-form">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblFeedbackComplaintType %></label>
                            <div class="col-sm-6">
                                <asp:TextBox ID="txtFeedbackComplaintType" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
