<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Faqs_View, App_Web_faqs_view.aspx.1f2a64c3" %>

<%@ Register TagPrefix="cc1" Assembly="Custom_Button" Namespace="Custom_Button" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script>
        $(window).load(function () {
            $('#tblData_Faq').DataTable({
                stateSave: true
            });
            $('#tblData_Faq2').DataTable({
                stateSave: true
            });
        });
    </script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><%= Resources.CMS_Resource.lblFaqs %></li>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphBodyContent" runat="Server">
    <div class="body-nest" id="footable" runat="server">
        <table id="tblData_Faq" class="table-striped  footable metro-blue gvDataClass" width="100%">
            <thead>
                <tr>
                    <th><%= Resources.CMS_Resource.lblQuestion %></th>
            ...
            <tbody>
                <asp:Repeater ID="rptData" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td style="width: 35%"><%# Eval("QUESTION") %></td>
                            ...
                            <td class="Hiddein_TD"><%# Localization.StripTagsRegex(Eval("QUESTION").ToString()) %></td>
                            <td class="Hiddein_TD"><%# Localization.StripTagsRegex(Eval("ANSWER").ToString()) %></td>
                            <td style="width: 15%">
    ...
    <div class="body-nest no-padding-bot">
        ...
        <div runat="server" id="footable2">
            <table id="tblData_Faq2" class="table-striped  footable metro-blue gvDataClass" width="100%">
                <thead>
                    <tr>
                        <th><%= Resources.CMS_Resource.lblQuestion %></th>
                ...
                <tbody>
                    <asp:Repeater ID="rptData2" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                <td style="width: 25%"><%# Eval("QUESTION") %></td>
