<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Job_Auditing, App_Web_job_auditing.aspx.1f2a64c3" %>
                                ...
                                <ContentTemplate>
                                    <div class="form-horizontal bucket-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <asp:TextBox ID="txtPublicationDate" runat="server" CssClass="form-control ReqValidation"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
