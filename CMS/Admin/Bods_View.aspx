<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Bods_View, App_Web_bods_view.aspx.1f2a64c3" %>

<%@ Register TagPrefix="cc1" Assembly="Custom_Button" Namespace="Custom_Button" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script>
        $(window).load(function () {
            $('#tblData_Bod').DataTable({
                stateSave: true
            });
            $('#tblData_Bod2').DataTable({
                stateSave: true
            });
        });
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphTitle" runat="Server">
    <span><%= Resources.CMS_Resource.lblBods %></span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        <li><a href="Dashboard.aspx"><%= Resources.CMS_Resource.lblDashboard %></a></li>
        <li><i class="fa fa-lg fa-angle-right"></i></li>
        <li><%= Resources.CMS_Resource.lblBods %></li>
        <li class="pull-right" runat="server" id="Div_AddNew">
            <div class="input-group input-widget">
                <a href="Bod_AddEdit.aspx" class="btn btn-danger"><%= Resources.CMS_Resource.lblCreateNew %> <%= Resources.CMS_Resource.lblBod %></a>
            </div>
        </li>
    </ul>
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="cphBodyContent" runat="Server">
    <div class="body-nest" id="footable" runat="server">
        <table id="tblData_Bod" class="table-striped  footable metro-blue gvDataClass" width="100%">
            <thead>
                <tr>
                ...
                <asp:Repeater ID="rptData" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 15%"><%# Eval("TYPE_NAME") %></td>
                            ...
                            <td class="Hiddein_TD"><%# Eval("JOB_TITLE").ToString() %></td>
                            <td class="Hiddein_TD"><%# Eval("BRIEF").ToString() %></td>
                            <td style="width: 15%">
    ...
    <div class="body-nest no-padding-bot">
        ...
        <div runat="server" id="footable2">
            <table id="tblData_Bod2" class="table-striped  footable metro-blue gvDataClass" width="100%">
                <thead>
                    <tr>
                        <th><%= Resources.CMS_Resource.lblName %></th>
                        <th><%= Resources.CMS_Resource.lblType %></th>
                    ...
                    <asp:Repeater ID="rptData2" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="width: 12%"><%# Eval("TYPE_NAME") %></td>
                                ...
                                <td style="width: 8%"><%# Localization.GetCheckedDate(Eval("CREATED_DATE"))%></td>
                                <td style="width: 8%"><%# Localization.CheckResponseForPending(Eval("ID_STATUS"),Eval("RESPONSE_BY_NAME")) %></td>
                                <td style="width: 8%"><%# Localization.CheckResponseForPending(Eval("ID_STATUS"),Localization.GetCheckedDate(Eval("RESPONSE_DATE")))%></td>
                                <td class="Hiddein_TD"><%# Eval("JOB_TITLE").ToString() %></td>
                                <td class="Hiddein_TD"><%# Eval("BRIEF").ToString() %></td>
                                <td style="width: 15%">
