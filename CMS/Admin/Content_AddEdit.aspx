<%@ page title="Imagin grp. : Content Management System" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Content_AddEdit, App_Web_content_addedit.aspx.1f2a64c3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphTitle" runat="Server">
    <span><%= Resources.CMS_Resource.lblContents %></span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        <li><a href="Dashboard.aspx"><%= Resources.CMS_Resource.lblDashboard %></a></li>
        <li><i class="fa fa-lg fa-angle-right"></i></li>
        <li><a href="Contents_View.aspx"><%= Resources.CMS_Resource.lblContents %></a></li>
        <li><i class="fa fa-lg fa-angle-right"></i></li>
        <li runat="server" id="li_BreadCrumbs"></li>
        <li class="pull-right" runat="server" id="li_AddNew">
            <div class="input-group input-widget">
                <a href="Content_AddEdit.aspx" class="btn btn-danger"><%= Resources.CMS_Resource.lblCreateNew %> <%= Resources.CMS_Resource.lblContent %></a>
            </div>
        </li>
    </ul>
</asp:Content>
                                ...
                                <ContentTemplate>
                                    <div class="form-horizontal bucket-form">
                                        <div runat="server" id="div_tab_main">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblParentContent %></label>
                                                <div class="col-sm-6">
                                                    <asp:DropDownList ID="ddlParentContent" runat="server" CssClass="form-control"></asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6 skin-flat list cb_Row_Height">
                                                    <div class="col-sm-4">
                                                        <asp:CheckBox CssClass="frm_Checkbox" ID="cbShowInMenu1" runat="server" type="checkbox"></asp:CheckBox>
                                                        <label for="flat-checkbox-1"><%= Resources.CMS_Resource.lblShowInMenu1 %></label>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <asp:CheckBox CssClass="frm_Checkbox" ID="cbShowInMenu2" runat="server" type="checkbox"></asp:CheckBox>
                                                        <label for="flat-checkbox-1"><%= Resources.CMS_Resource.lblShowInMenu2 %></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group" id="DivFooterOrder" runat="server" >
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblFooterOrder %></label>
                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="txtFooterOrder" runat="server" CssClass="form-control " type="number"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblContentLink %></label>
                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="txtContentLink" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                    ...
                                                    <asp:UpdatePanel runat="server" ID="upImage" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            ...
                                                            <div class="help-block">
                                                                ...
                                                                <asp:Literal runat="server" ID="lFieldMessage_Image" Text="<%$ Resources:CMS_Resource, SourceFolder %>"></asp:Literal><span><%= ConfigurationManager.AppSettings["Att_Content"] %></span>
                                                            </div>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblParentContent %></label>
                                    <div class="col-sm-6">
                                        <asp:DropDownList ID="ddlParentContent_Save" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblTitle %></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 skin-flat list cb_Row_Height">
                                        <div class="col-sm-4">
                                            <asp:CheckBox CssClass="frm_Checkbox" ID="cbShowInMenu1_Save" runat="server" type="checkbox"></asp:CheckBox>
                                            <label for="flat-checkbox-1"><%= Resources.CMS_Resource.lblShowInMenu1 %></label>
                                        </div>
                                        <div class="col-sm-4">
                                            <asp:CheckBox CssClass="frm_Checkbox" ID="cbShowInMenu2_Save" runat="server" type="checkbox"></asp:CheckBox>
                                            <label for="flat-checkbox-1"><%= Resources.CMS_Resource.lblShowInMenu2 %></label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group" id="DivFooterOrder_Save" runat="server">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblFooterOrder %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtFooterOrder_Save" runat="server" CssClass="form-control " type="number"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblContentLink %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtContentLink_Save" runat="server" CssClass="form-control "></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblImage %></label>
                                    <div class="col-sm-6">
                                        ...
                                        <div class="help-block">
                                            ...
                                            <asp:Literal runat="server" ID="lFieldMessage_Image_Save" Text="<%$ Resources:CMS_Resource, SourceFolder %>"></asp:Literal><span><%= ConfigurationManager.AppSettings["Att_Content"] %></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ContainFTB">
