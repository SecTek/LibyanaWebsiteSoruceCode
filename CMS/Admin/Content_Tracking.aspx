<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Content_Tracking, App_Web_content_tracking.aspx.1f2a64c3" %>
    ...
    <asp:UpdatePanel ID="upbreadcrumb" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <ul id="breadcrumb">
                ...
                <li><a href="../Admin/Contents_View.aspx"><%= Resources.CMS_Resource.lblContents %></a></li>
                <li><i class="fa fa-lg fa-angle-right"></i></li>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"></label>
                                    <div class="col-sm-6 skin-flat list cb_Row_Height">
                                        <asp:CheckBox CssClass="frm_Checkbox" ID="cbShowInMenu1_Old" runat="server" type="checkbox"></asp:CheckBox>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"></label>
                                    <div class="col-sm-6 skin-flat list cb_Row_Height">
                                        <asp:CheckBox CssClass="frm_Checkbox" ID="cbShowInMenu2_Old" runat="server" type="checkbox"></asp:CheckBox>
                                ...
                                <div class="form-group" id="DivFooterOrder_Old" runat="server">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblFooterOrder %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtFooterOrder_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblContentLink %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtContentLink_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"></label>
                                    <div class="col-sm-6 skin-flat list cb_Row_Height">
                                        <asp:CheckBox CssClass="frm_Checkbox" ID="cbShowInMenu1_New" runat="server" type="checkbox"></asp:CheckBox>
                                        <label for="flat-checkbox-1"><%= Resources.CMS_Resource.lblShowInMenu1 %></label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"></label>
                                    <div class="col-sm-6 skin-flat list cb_Row_Height">
                                        <asp:CheckBox CssClass="frm_Checkbox" ID="cbShowInMenu2_New" runat="server" type="checkbox"></asp:CheckBox>
                                        <label for="flat-checkbox-1"><%= Resources.CMS_Resource.lblShowInMenu2 %></label>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" id="DivFooterOrder_New" runat="server">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblFooterOrder %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtFooterOrder_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblContentLink %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtContentLink_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblImage %></label>
