<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="AddedValueType_Auditing, App_Web_addedvaluetype_auditing.aspx.1f2a64c3" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><a href="AddedValueTypes_View.aspx"><%= Resources.CMS_Resource.lblAddedValueTypes %></a></li>
        <li><i class="fa fa-lg fa-angle-right"></i></li>
                                    ...
                                    <div class="form-horizontal bucket-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6 skin-flat list CA_Row_Height">
                                                <div class="col-sm-3 ">
                                                    <asp:CheckBox CssClass="frm_Checkbox" ID="CAIsActive" runat="server" type="checkbox"></asp:CheckBox>
