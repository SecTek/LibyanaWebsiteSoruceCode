<%@ page title="Imagin grp. : Content Management System" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Product_AddEdit, App_Web_product_addedit.aspx.1f2a64c3" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><a href="Products_View.aspx"><%= Resources.CMS_Resource.lblProducts %></a></li>
        <li><i class="fa fa-lg fa-angle-right"></i></li>
        <li runat="server" id="li_BreadCrumbs"></li>
        <li class="pull-right" runat="server" id="li_AddNew">
            <div class="input-group input-widget">
                <a href="Product_AddEdit.aspx" class="btn btn-danger"><%= Resources.CMS_Resource.lblCreateNew %> <%= Resources.CMS_Resource.lblProduct %></a>
            </div>
        </li>
    </ul>
</asp:Content>
                    ...
                    <section class="UnderValidationSection">
                        <div class="panel-body">
                            <asp:UpdatePanel runat="server" ID="upEntry" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div class="form-horizontal bucket-form">
                                        <div runat="server" id="div_tab_main">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblParentProduct %></label>
                                                <div class="col-sm-6">
                                                    <asp:DropDownList ID="ddlParentProduct" runat="server" CssClass="form-control"></asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6 skin-flat list cb_Row_Height">
                                                    ...
                                                    <div class="col-sm-4 ">
                                                        <asp:CheckBox CssClass="frm_Checkbox" ID="cbIsLink" runat="server" type="checkbox"></asp:CheckBox>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6 skin-flat list cb_Row_Height">
                                                    <div class="col-sm-4 ">
                                                        <asp:CheckBox CssClass="frm_Checkbox" ID="cbShowInDropMenu" runat="server" type="checkbox"></asp:CheckBox>
                                            ...
                                            <div class="form-group" runat="server" id="DivSmallImage">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblSmallImage%></label>
                                                <div class="col-sm-6">
                                                    <asp:UpdatePanel runat="server" ID="upSmallImage" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <telerik:RadDropDownList ID="ddlSmallImage" runat="server" DataTextField="Name" Width="22.000em" DropDownHeight="200px" Skin="Vista">
                                                                <ItemTemplate>
                                                                    <table cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                         ...
                                                                         <%--   <td class="ddlImageTD">
                                                                                <asp:Image ID="SmallImage" runat="server" CssClass="ddlImage" ImageUrl=' <%# DataBinder.Eval(Container.DataItem, "FileName")%>' Visible='<%# GetImage(Eval("FileName")) %>' />
                                                                            </td>--%>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="2">
                                                            ...
                                                            <div class="help-block">
                                                                <asp:Label ID="lblSmallImageDimensions" runat="server"></asp:Label>
                                                            </div>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                                    ...
                                                    <asp:UpdatePanel runat="server" ID="upImage" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            ...
                                                            <div class="help-block">
                                                                ...
                                                                <asp:Literal runat="server" ID="lFieldMessage_Image" Text="<%$ Resources:CMS_Resource, SourceFolder %>"></asp:Literal><span><%= ConfigurationManager.AppSettings["Att_Product"] %></span>
                                                            </div>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <asp:TextBox ID="txtTitleDropMenu" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblLinkDropMenu %></label>
                                                <div class="col-sm-8">
                                                    <asp:TextBox ID="txtLinkDropMenu" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblTextLinkDropMenu %></label>
                                                <div class="col-sm-8">
                                                    <asp:TextBox ID="txtTextLinkDropMenu" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblBodyLinkDropMenu %></label>
                                                <div class="col-sm-8">
                                                    <asp:TextBox ID="txtBodyLinkDropMenu" runat="server" CssClass="form-control" Style="height: 150px !important" TextMode="MultiLine"></asp:TextBox>
                                                </div>
                                            </div>
                                ...
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="cbIsLink" EventName="CheckedChanged" />
                                </Triggers>
                            </asp:UpdatePanel>
                        </div>
                    </section>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblParentProduct %></label>
                                    <div class="col-sm-6">
                                        <asp:DropDownList ID="ddlParentProduct_Save" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblTitle %></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 skin-flat list cb_Row_Height">
                                        ...
                                        <div class="col-sm-4 ">
                                            <asp:CheckBox CssClass="frm_Checkbox" ID="cbIsLink_Save" runat="server" type="checkbox"></asp:CheckBox>
                                            <label for="flat-checkbox-1"><%= Resources.CMS_Resource.lblIsLink %></label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 skin-flat list cb_Row_Height">
                                        <div class="col-sm-4 ">
                                            <asp:CheckBox CssClass="frm_Checkbox" ID="cbShowInDropMenu_Save" runat="server" type="checkbox"></asp:CheckBox>
                                            <label for="flat-checkbox-1"><%= Resources.CMS_Resource.lblShowInDropMenu %></label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblProductLink %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtProductLink_Save" runat="server" CssClass="form-control "></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group" runat="server" id="DivSmallImage_Save">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblSmallImage%></label>
                                    <div class="col-sm-6">
                                        <asp:UpdatePanel runat="server" ID="upSmallImage_Save" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <telerik:RadDropDownList ID="ddlSmallImage_Save" runat="server" DataTextField="Name" Width="22.000em" DropDownHeight="200px" Skin="Vista">
                                                    <ItemTemplate>
                                                        <table cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td width="190px">
                                                               ...
                                                               <%-- <td class="ddlImageTD">
                                                                    <asp:Image ID="SmallImage_Save" runat="server" CssClass="ddlImage" ImageUrl=' <%# DataBinder.Eval(Container.DataItem, "FileName")%>' Visible='<%# GetImage(Eval("FileName")) %>' />
                                                                </td>--%>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2">
                                                ...
                                                <div class="help-block">
                                                    <asp:Label ID="lblSmallImageDimensions_Save" runat="server"></asp:Label>
                                                </div>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="help-block">
                                            ...
                                            <asp:Literal runat="server" ID="lFieldMessage_Image_Save" Text="<%$ Resources:CMS_Resource, SourceFolder %>"></asp:Literal><span><%= ConfigurationManager.AppSettings["Att_Product"] %></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ContainFTB">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblTitleDropMenu %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtTitleDropMenu_Save" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblLinkDropMenu %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtLinkDropMenu_Save" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblTextLinkDropMenu %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtTextLinkDropMenu_Save" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblBodyLinkDropMenu %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtBodyLinkDropMenu_Save" runat="server" CssClass="form-control" Style="height: 150px !important" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
