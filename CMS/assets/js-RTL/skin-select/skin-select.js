$(document).ready(function() { 
	...
	$("#skin-select #toggle").click(function() { 
		...
		if($(this).hasClass('active')) {
			...
			$('.datepicker-wrap').css({ "position": "absolute", "left": "300px" });
			...
			$('.dropdown-wrap').css({ "position": "absolute", "right": "0px", "top": "53px" });
			...
			$('.datepicker-wrap').css({"position":"absolute", "left":"84px"});
			
			$('.skin-part').css({"visibility":"visible", "top":"3px"});
			$('.dark').css({"visibility":"hidden"});
			$('#menu-showhide, .menu-left-nest').css({"margin":"0"});

			$('.search-hover').css({ "display": "block", "position": "absolute", "left": "-100px" });

			$('.dropdown-wrap').css({ "position": "absolute", "right": "-10px", "top": "53px" });
