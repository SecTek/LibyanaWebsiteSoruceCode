<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Addresses_View, App_Web_addresses_view.aspx.1f2a64c3" %>

<%@ Register TagPrefix="cc1" Assembly="Custom_Button" Namespace="Custom_Button" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
      <script>
        $(window).load(function () {
            $('#tblData_Address').DataTable({
                stateSave: true
            });
            $('#tblData_Address2').DataTable({
                stateSave: true
            });
        });
</script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        ...
        <li><%= Resources.CMS_Resource.lblAddresses %></li>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphBodyContent" runat="Server">
    <div class="body-nest" id="footable" runat="server">
        <table id="tblData_Address" class="table-striped  footable metro-blue gvDataClass" width="100%">
            <thead>
                <tr>
                ...
                <asp:Repeater ID="rptData" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="Hiddein_TD"><%# Eval("TEL_1") %></td>
                            <td class="Hiddein_TD"><%# Eval("TEL_2") %></td>
                            <td class="Hiddein_TD"><%# Eval("TEL_3") %></td>
                            <td class="Hiddein_TD"><%# Eval("FAX_1") %></td>
                            <td class="Hiddein_TD"><%# Eval("FAX_2") %></td>
                            <td class="Hiddein_TD"><%# Eval("EMAIL") %></td>
                            <td class="Hiddein_TD"><%# Eval("LATITUDE") %></td>
                            <td class="Hiddein_TD"><%# Eval("LONGITUDE") %></td>
                            <td class="Hiddein_TD"><%# Eval("OPERATION_HOURS")%></td>
    ...
    <div class="body-nest no-padding-bot">
        ...
        <table id="tblData_Address2" class="table-striped  footable metro-blue gvDataClass" width="100%">
                <thead>
                    <tr>
                        <th><%= Resources.CMS_Resource.lblTitle %></th>
