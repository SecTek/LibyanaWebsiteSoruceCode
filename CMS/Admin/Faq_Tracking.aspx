<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Faq_Tracking, App_Web_faq_tracking.aspx.1f2a64c3" %>
    ...
    <asp:UpdatePanel ID="upbreadcrumb" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <ul id="breadcrumb">
                ...
                <li><a href="../Admin/Faqs_View.aspx"><%= Resources.CMS_Resource.lblFaqs %></a></li>
                <li><i class="fa fa-lg fa-angle-right"></i></li>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtQuestion_Old" runat="server" CssClass="form-control" TextMode="MultiLine" Style="height: 200px !important"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblAnswer %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtAnswer_Old" runat="server" CssClass="form-control" TextMode="MultiLine" Style="height: 200px !important"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblQuestion %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtQuestion_New" runat="server" CssClass="form-control" TextMode="MultiLine" Style="height: 200px !important"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblAnswer %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtAnswer_New" runat="server" CssClass="form-control" TextMode="MultiLine" Style="height: 200px !important"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"></label>
