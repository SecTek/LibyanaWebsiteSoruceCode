<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Event_Tracking, App_Web_event_tracking.aspx.1f2a64c3" %>
    ...
    <asp:UpdatePanel ID="upbreadcrumb" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <ul id="breadcrumb">
                ...
                <li><a href="../Admin/Events_View.aspx"><%= Resources.CMS_Resource.lblEvents %></a></li>
                <li><i class="fa fa-lg fa-angle-right"></i></li>
                    ...
                    <section>
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                ...
                                <div class="form-group" id="Div_ShowinHomePage_Old" runat="server">
                                    <label class="col-sm-3 control-label"></label>
                                    <div class="col-sm-6 skin-flat list cb_Row_Height">
                                        <asp:CheckBox CssClass="frm_Checkbox" ID="cbShowinHomePage_Old" runat="server" type="checkbox"></asp:CheckBox>
                    ...
                    <section>
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                ...
                                <div class="form-group" id="Div_ShowinHomePage_New" runat="server">
                                    <label class="col-sm-3 control-label"></label>
                                    <div class="col-sm-6 skin-flat list cb_Row_Height">
                                        <asp:CheckBox CssClass="frm_Checkbox" ID="cbShowinHomePage_New" runat="server" type="checkbox"></asp:CheckBox>
                                        <label for="flat-checkbox-1"><%= Resources.CMS_Resource.lblShowinHomePage %></label>
                                    </div>
                                </div>
                                <div class="form-group">
