<%@ page title="" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Address_Tracking, App_Web_address_tracking.aspx.1f2a64c3" %>
    ...
    <asp:UpdatePanel ID="upbreadcrumb" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <ul id="breadcrumb">
                ...
                <li><a href="../Admin/Addresses_View.aspx"><%= Resources.CMS_Resource.lblAddresses %></a></li>
                <li><i class="fa fa-lg fa-angle-right"></i></li>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                ...
                                <div class="form-group" style="display: none">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtTel2_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group" style="display: none">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblTel3 %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtTel3_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group" style="display: none">
                                ...
                                <div class="form-group" style="display: none">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtFax2_Old" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group" style="display: none">
                                ...
                                <div class="form-group">
                                    <uc1:CustomRadEditor runat="server" ID="reOperationHours_Old" />
                                </div>
                                <div class="form-group" style="display: none">
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal bucket-form">
                                ...
                                <div class="form-group" style="display: none">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblTel2 %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtTel2_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group" style="display: none">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblTel3 %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtTel3_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group" style="display: none">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblFax %></label>
                                ...
                                <div class="form-group" style="display: none">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblFax2 %></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtFax2_New" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group" style="display: none">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblEmail %></label>
                                ...
                                <div class="form-group">
                                    <uc1:CustomRadEditor runat="server" ID="reOperationHours_New" />
                                </div>
                                <div class="form-group" style="display: none">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblImage %></label>
