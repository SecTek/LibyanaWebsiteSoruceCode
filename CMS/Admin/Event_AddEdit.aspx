<%@ page title="Imagin grp. : Content Management System" language="C#" masterpagefile="~/CMS/MasterPage.master" autoeventwireup="true" inherits="Event_AddEdit, App_Web_event_addedit.aspx.1f2a64c3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphTitle" runat="Server">
    <span><%= Resources.CMS_Resource.lblEvents %></span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    <ul id="breadcrumb">
        <li><a href="Dashboard.aspx"><%= Resources.CMS_Resource.lblDashboard %></a></li>
        <li><i class="fa fa-lg fa-angle-right"></i></li>
        <li><a href="Events_View.aspx"><%= Resources.CMS_Resource.lblEvents %></a></li>
        <li><i class="fa fa-lg fa-angle-right"></i></li>
        <li runat="server" id="li_BreadCrumbs"></li>
        <li class="pull-right" runat="server" id="li_AddNew">
            <div class="input-group input-widget">
                <a href="Event_AddEdit.aspx" class="btn btn-danger"><%= Resources.CMS_Resource.lblCreateNew %> <%= Resources.CMS_Resource.lblEvent %></a>
            </div>
        </li>
    </ul>
</asp:Content>
                                        ...
                                        <div runat="server" id="div_tab_main">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6 skin-flat list cb_Row_Height">
                                                    ...
                                                    <div class="col-sm-5" runat="server" id="DivcbShowinHomePage">
                                                        <asp:CheckBox CssClass="frm_Checkbox" ID="cbShowinHomePage" runat="server" type="checkbox"></asp:CheckBox>
                                                        <label for="flat-checkbox-1"><%= Resources.CMS_Resource.lblShowinHomePage %></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblPublicationDate %></label>
                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="dpPublicationDate" runat="server" CssClass="form-control ReqValidation DateValidation DatePicker" type="text"></asp:TextBox>
                                                </div>
                                            </div>
                                                    ...
                                                    <asp:UpdatePanel runat="server" ID="upImage" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            ...
                                                            <div class="help-block">
                                                                ...
                                                                <asp:Literal runat="server" ID="lFieldMessage_Image" Text="<%$ Resources:CMS_Resource, SourceFolder %>"></asp:Literal><span><%= ConfigurationManager.AppSettings["Att_Event"] %></span>
                                                            </div>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                            ...
                            <div class="form-horizontal bucket-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 skin-flat list cb_Row_Height">
                                        ...
                                        <div class="col-sm-5" runat="server" id="DivcbShowinHomePage_Save">
                                            <asp:CheckBox CssClass="frm_Checkbox" ID="cbShowinHomePage_Save" runat="server" type="checkbox"></asp:CheckBox>
                                            <label for="flat-checkbox-1"><%= Resources.CMS_Resource.lblShowinHomePage %></label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><%= Resources.CMS_Resource.lblPublicationDate %></label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="dpPublicationDate_Save" runat="server" CssClass="form-control ReqValidation DateValidation DatePicker" type="text"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="help-block">
                                            ...
                                            <asp:Literal runat="server" ID="lFieldMessage_Image_Save" Text="<%$ Resources:CMS_Resource, SourceFolder %>"></asp:Literal><span><%= ConfigurationManager.AppSettings["Att_Event"] %></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ContainFTB">
